...
conda activate
conda install -q -y conda "numpy>=1.17" hdf5 scipy numba numexpr mkl cython  "jupyterlab=2.2.6"  jupyter scikit-image appdirs mako scikit-learn "python>=3.7" seaborn pandas line_profiler black ninja colorama memory_profiler isort mkl-devel fastrlock six setuptools
